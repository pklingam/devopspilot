...
<%  String empid =(String)session.getAttribute("username");
 %>
<form action="saveModify.jsp"  method="post" name="upload" onsubmit="return validate()">
<!-- <div id="firstDiv"> -->
...
%>
 ...
 <br>
   <center><button type="submit" id="myButton" style="background-color: #DCDCDC">Submit</button>
   <br>
   <br>
 </center>
 </div>
